...
class EGF_Test_Settings extends WP_UnitTestCase {
	...
	public function test_parse_config_args() {
		...
		$this->assertArrayHasKey( 'font_size_min_range', $test_config_props['properties'] );
		$this->assertArrayHasKey( 'font_size_max_range', $test_config_props['properties'] );
		$this->assertArrayHasKey( 'font_size_step', $test_config_props['properties'] );
		$this->assertArrayHasKey( 'line_height_min_range', $test_config_props['properties'] );
		$this->assertArrayHasKey( 'line_height_max_range', $test_config_props['properties'] );
		$this->assertArrayHasKey( 'line_height_step', $test_config_props['properties'] );
		$this->assertArrayHasKey( 'letter_spacing_min_range', $test_config_props['properties'] );
		$this->assertArrayHasKey( 'letter_spacing_max_range', $test_config_props['properties'] );
		$this->assertArrayHasKey( 'letter_spacing_step', $test_config_props['properties'] );
		$this->assertArrayHasKey( 'margin_min_range', $test_config_props['properties'] );
		$this->assertArrayHasKey( 'margin_max_range', $test_config_props['properties'] );
		$this->assertArrayHasKey( 'margin_step', $test_config_props['properties'] );
		$this->assertArrayHasKey( 'padding_min_range', $test_config_props['properties'] );
		$this->assertArrayHasKey( 'padding_max_range', $test_config_props['properties'] );
		$this->assertArrayHasKey( 'padding_step', $test_config_props['properties'] );
		$this->assertArrayHasKey( 'border_min_range', $test_config_props['properties'] );
		$this->assertArrayHasKey( 'border_max_range', $test_config_props['properties'] );
		$this->assertArrayHasKey( 'border_step', $test_config_props['properties'] );
		$this->assertArrayHasKey( 'border_radius_min_range', $test_config_props['properties'] );
		$this->assertArrayHasKey( 'border_radius_max_range', $test_config_props['properties'] );
		$this->assertArrayHasKey( 'border_radius_step', $test_config_props['properties'] );
