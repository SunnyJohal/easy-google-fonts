...
/**
 * Handle for inline css generated by
 * this plugin.
 *
 * @return string handle.
 */
function get_inline_font_styles_handle() {
	return 'https://easy-google-fonts-styles';
}
 ...
 * @return array response object to short circuit wp_remote_get()
 */
function mock_http_response( $body = '' ) {
	return [
		'body'     => $body,
